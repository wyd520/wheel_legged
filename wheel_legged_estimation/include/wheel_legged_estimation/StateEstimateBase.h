...
#include <wheel_legged_common/hardware_interface/HybridJointInterface.h>
...
#include <wheel_legged_interface/gait/ModeSequenceTemplate.h>
...
class StateEstimateBase {
 public:
  ...
  // const ModeSequenceTemplate& modeSchedule_;

  void setModeSchedule(const ModeSchedule& schedule){
    modeSchedule_ = schedule;
  };
  // const ocs2::ModeSchedule& getModeSchedule() const { return modeSchedule_; }
